...
class UsuariosView(Frame):
    def __init__(self, parent):
        ...
        self.search_entry.grid(row=1, column=1, padx=10, pady=10, sticky="ew", ipadx=5, ipady=5)
        
        self.search_button = tk.Button(self, text="Buscar", command=self.search_user, font=("Arial", 12), bg="lightblue", width=12)
        self.search_button.grid(row=1, column=2, padx=10, pady=10, sticky="ew")
        ...
        self.treeview.column("Contraseña", width=150, anchor="center", stretch=tk.YES)
        self.treeview.column("Rol", width=100, anchor="center", stretch=tk.YES)
